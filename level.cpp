...
void Level::loadMap(std::string mapName, Graphics &graphics) {
    ...
    XMLDocument doc;
    std::stringstream ss;
    ss << "/Users/njvanhaute/Desktop/CaveStoryRemade/CaveStoryRemade/CaveStoryRemade/Debug/content/maps/" << mapName << ".tmx"; //Pass in map1, we get maps/map1.tmx
    ...
    // Parse the collision rectangles
